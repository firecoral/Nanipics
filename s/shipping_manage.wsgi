...
def application(environ, start_response):
    ...
    try:
        ...
        request.add_vars({ 'lab_hier': get_lab_shipping_costs() })
        t = DTemplate(request, 'shipping_manage.html')
