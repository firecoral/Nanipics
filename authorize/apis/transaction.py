...
class TransactionAPI(object):
    ...
    def _add_params(self, params, credit_card=None, address=None, invoice=None):
        if credit_card:
            params.update({
    ...
    def auth(self, amount, credit_card, address=None, invoice=None):
        amount = Decimal(str(amount)).quantize(Decimal('0.01'))
        params = self.base_params.copy()
        params = self._add_params(params, credit_card, address, invoice)
